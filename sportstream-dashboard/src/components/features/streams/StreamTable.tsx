...
export function StreamTable() {
  ...
  return (
    <div className="space-y-8">
      {/* Filters row (passed from parent, but rendered inline for context) */}
      <StreamFilters
        status={status}
        type={type}
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-surface-container-low p-6 rounded-2xl flex flex-col justify-between h-32 border border-outline-variant/10">
          <span className="text-[10px] font-black uppercase tracking-widest text-outline">Total Active Streams</span>
          <div className="flex items-end justify-between">
            <span className="text-3xl font-black text-on-surface">{(streams ?? []).length}</span>
        ...
        <div className="bg-surface-container-low p-6 rounded-2xl flex flex-col justify-between h-32 border border-outline-variant/10">
          ...
          <div className="flex items-end justify-between">
            <span className="text-3xl font-black text-on-surface">4.2 TB</span>
        ...
        <div className="bg-sidebar-bg p-6 rounded-2xl flex flex-col justify-between h-32 relative overflow-hidden group">
